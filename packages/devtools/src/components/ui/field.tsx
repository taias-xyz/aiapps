...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: generated file from shadcn/ui
    <div
      role="group"
      data-slot="field"
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    // biome-ignore lint/suspicious/noDoubleEquals: generated file from shadcn/ui
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: generated file from shadcn/ui
